...
public class MainActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button bntSecAct = (Button) findViewById(R.id.btnAct2);
        btnEnvoyer.setOnClickListener(bntSecActOnClickListener);
    ...
    View.OnClickListener bntSecActOnClickListener = new View.OnClickListener() {
        @Override
        public void onClick(View v) {
