...
public class MainActivity extends AppCompatActivity {
        ...
        public void onClick(View v) {
            ...
            if (tValue <= 0)
                ...
                if (pValue <= 0)
                    ...
                    String appreciation = interpreteIMC(imc);
                    String resultat = "Votre IMC est " + imc + " "+ appreciation + " . ";
    ...
    private TextWatcher textWatcher = new TextWatcher() {
        ...
        public void beforeTextChanged(CharSequence s, int start, int count, int after) {
            if(s.toString().contains(".")){
                RadioButton radio_metre = findViewById(R.id.radio_metre);
    ...
    public String interpreteIMC(float imc){
        String appreciation = "";
        if(imc < 16.5) appreciation = "famine";
        else if(imc < 18.5) appreciation = getString(R.string.maigre);
        else if(imc < 25) appreciation = getString(R.string.normal);
        else if(imc < 30) appreciation = getString(R.string.obesite_modere);
        else if(imc < 35) appreciation = getString(R.string.maigre);
        else if(imc < 40) appreciation = getString(R.string.tgros);
        else if(imc > 40) appreciation = getString(R.string.ttgros);
        return appreciation;
    }
